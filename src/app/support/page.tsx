...
export default function SupportPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Você pode excluir sua conta permanentemente acessando Configurações > Gerenciar conta > Deletar minha conta. Todos os seus dados serão removidos em até 30 dias.',
      icon: Trash2,
    },
    {
